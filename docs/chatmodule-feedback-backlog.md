...
Передача накопленных требований от 22 сентября 2026:
[Production → ChatModule: аудит, доработки и публикация](./chatmodule-upstream-handoff-2026-09-22.md).
Она отделяет срочный выпуск существующего localization patch от новых общих
контрактов и продуктовых адаптеров; CM IDs ниже сохраняются.
