...
Статус: **переключение выполнено 22.09.2026, публичные сервисы работают**.
Итоговые версии, серверная конфигурация и границы проверки записаны в
[отчёте о деплое](./production-deployment-2026-09-22.md).
Ниже сохранён исходный план и снимок сервера **до переключения**; старые image tags
и отсутствие публичного storage endpoint в нём не описывают текущий runtime.
