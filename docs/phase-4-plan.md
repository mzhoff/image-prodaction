...
Обновленный системный контекст и терминология зафиксированы отдельно: [product-architecture.md](./product-architecture.md).

Практический порядок работ по этапу 4 и соседним слоям зафиксирован в объединенном плане: [product-roadmap.md](./product-roadmap.md).
